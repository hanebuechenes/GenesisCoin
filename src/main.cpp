...
uint256 hashGenesisBlock("0x999bec5f74e26484e056e432c18412cee9114742768bf8f8e21dc6416e5d8d57");
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // GenesisCoin: 0.35 days
static const int64 nTargetSpacing = 15; // GenesisCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal GenesisCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GenesisCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "GenesisCoin starting point";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1532638148;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087745984;
        ...
        assert(block.hashMerkleRoot == uint256("0x87911a5d1076b16141c4e0f4b2dcd1d0a7ce8aa21d2f92b99df3a38a3227880b"));
